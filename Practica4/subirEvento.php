...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($idEvento != -1) {
        if (!isset($imagenes))
            modificarEvento($idEvento, $nombre, $organizador, $etiquetas, $fecha, $descripcion, $mysqli);
        else
            modificarEventoImg($idEvento, $nombre, $organizador, $etiquetas, $fecha, $descripcion, $imagenes, $mysqli);
    } else {
        $idEvento = nuevoEvento($nombre, $organizador, $etiquetas, $fecha, $descripcion, $imagenes, $mysqli);
    }
